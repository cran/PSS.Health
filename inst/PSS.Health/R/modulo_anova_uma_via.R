        ...
        if (input$calcular_utilizando_f) {
          tagList(
            ...
            numericInput( ns("k"),
                          ...
                          max = Inf,
                          step = 1
            ) %>% .help_buttom(body = paste0(translation_pss("Número de grupos", linguagem()), txt_ajuda()$txt_definido_pesquisador)),
            ...
            if (tipo == "poder") {
              numericInput( ns("n_por_k"),
                            ...
                            max = Inf,
                            step = 1
              ) %>% .help_buttom(body = paste0(translation_pss("Número de observações (por grupo)", linguagem()), txt_ajuda()$txt_definido_pesquisador))
            }
          )
          ...
          tagList(
            ...
            textInput( ns("medias"),
              ...
              .help_buttom(title = translation_pss("Médias dos grupos", linguagem()),
                           body = paste0(
                             ajuda_cenarios_multiplos_valores2(),
            ...
            if (tipo == "poder") {
              textInput( ns("n_por_k_texto"),
                         translation_pss("Número de observações (por grupo)", linguagem()),
                         value = "15, 16, 12"
              ) %>% .help_buttom(title = translation_pss("Número de observações (por grupo)", linguagem()),
